  ...
  useEffect(() => {
    if (event) {
      ...
      setFormData({
        ...
        categories: event.tags?.filter((tag) => tag !== event.category?.toLowerCase()) || [],
        socialLinks: event.socialLinks || {
          facebook: "",
          instagram: "",
          twitter: "",
        },
        allowAttendeeMessaging: event.allowAttendeeMessaging !== false, // Default to true if not set
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{ticket.available - ticket.sold} available</p>
